...
from Myapp.models import PokemonCard, Trainer
from django.core.files import File
import os

class Command(BaseCommand):
    help = 'Populate the database with predefined Pokemon cards and trainers'
    ...
    def populate_pokemon_cards(self):
        ...
        card14.save()
        card15 = PokemonCard(name="Jigglypuff",rarity= "Rare",hp= 115,card_type= "Fairy",attack= "Disarming Voice",
        ...
        card16.save()
        card17 = PokemonCard(name="Wobbuffet",rarity= "Rare",hp= 190,card_type= "Psychic",attack= "Destiny Bond",
        ...
        card19.save()
        card20 = PokemonCard(name= "Deoxys",rarity= "Rare",hp= 50,card_type= "Psychic",attack= "Cosmic Power",
